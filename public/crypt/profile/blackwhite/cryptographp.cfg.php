...
$charR = 255;    // Couleur des caract鑽es au format RGB: Red (0->255)
$charG = 255;    // Couleur des caract鑽es au format RGB: Green (0->255)
...
$charsizemax = 20;     // Taille maximum des caract鑽es
