...
$charB = 255;    // Couleur des caract鑽es au format RGB: Blue (0->255)

$charcolorrnd = false;     // Choix al饌toire de la couleur.
...
$charsizemin = 16;     // Taille minimum des caract鑽es
$charsizemax = 22;     // Taille maximum des caract鑽es

$charanglemax  = 10;    // Angle maximum de rotation des caracteres (0-360)
$charup   = true;       // D駱lacement vertical al饌toire des caract鑽es (true/false)
...
$noisepxmin = 500;     // Bruit: Nb minimum de pixels al饌toires
$noisepxmax = 1000;     // Bruit: Nb maximum de pixels al饌toires

$noiselinemin = 5;    // Bruit: Nb minimum de lignes al饌toires
$noiselinemax = 10;    // Bruit: Nb maximum de lignes al饌toires
