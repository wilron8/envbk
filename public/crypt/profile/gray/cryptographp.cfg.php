...
$charcolorrndlevel = 0;   // Niveau de clart・des caract鑽es si choix al饌toire (0->4)
                           // 0: Aucune s駘ection
...
$charsizemin = 18;     // Taille minimum des caract鑽es
$charsizemax = 18;     // Taille maximum des caract鑽es
...
$cryptgaussianblur = true;// Transforme l'image finale en brouillant: m騁hode Gauss (true/false)
                            // uniquement si PHP >= 5.0.0
$cryptgrayscal = true;    // Transforme l'image finale en d馮rad・de gris (true/false)
                            // uniquement si PHP >= 5.0.0
