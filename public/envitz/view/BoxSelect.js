...
Ext.define('envitz.view.BoxSelect', {
	...
	initComponent: function() {
		...
		me.processBoxSelect(me);
		me.callParent(arguments);
	},

	processBoxSelect: function(config) {
		config.childEls= [
			'listWrapper',
			'itemList',
			'inputEl',
		...
		config.fieldSubTpl = Ext.create('Ext.XTemplate',
									   '<div class="{hiddenDataCls}" role="presentation"></div>',
									   '<input id="{id}" type="{type}" {inputAttrTpl} class="{fieldCls} {typeCls} {editableCls}" autocomplete="off"',
									   '<tpl if="value"> value="{[Ext.util.Format.htmlEncode(values.value)]}"</tpl>',
									   '<tpl if="name"> name="{name}"</tpl>',
